NAME		=	perlin_visualiser
DEBUG_NAME	=	perlin_visualiserDebug
...
$(NAME): $(OBJ)
	@echo "$(RED)=====>Compiling perlin_visualizer Test<===== $(WHITE)"
...
$(DEBUG_NAME): $(DEBUG_OBJ)
	@echo "$(RED)=====>Compiling perlin_visualizer DEBUG<===== $(WHITE)"
